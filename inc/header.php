    ...
    <header class="header">
        ...
        <div class="right">
            <?php if(!empty($_SESSION['user'])) : ?>
                <a href="http://localhost/backend/movies/user/dashboard.php" class="link-btn-bis">Dashboard</a>
                <a href="http://localhost/backend/movies/user/logout.php" class="link-btn-ter">Déconnexion</a>
            <?php else: ?>
